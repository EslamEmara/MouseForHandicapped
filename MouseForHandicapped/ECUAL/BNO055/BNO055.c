...
void BNO055_Init()
{
	...
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_PAGE_ID, 0x01);
	// Configure ACC
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_ACC_CONFIG, NormalA << 5 | ABW_31_25Hz << 2 | AFS_2G );
	// Configure GYR
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_GYRO_CONFIG_0, GBW_23Hz << 3 | GFS_250DPS );
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_GYRO_CONFIG_1, NormalG);
	// Configure MAG
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_MAG_CONFIG, Normal << 5 | Regular << 3 | MODR_10Hz );
	
	// Select page 0 to read sensors
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_PAGE_ID, 0x00);

	// Select BNO055 gyro temperature source
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_TEMP_SOURCE, 0x01 );

	// Select BNO055 sensor units (temperature in degrees C, rate in dps, accel in mg)
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_UNIT_SEL, 0x01 );
	
	// Select BNO055 system power mode
	BNO055_WriteByte(BNO055_ADDRESS, BNO055_PWR_MODE, Normalpwr );
